...
export default function Home() {
    ...
    const careerOpacity = useTransform(scrollYProgress, [0.05, 0.2], [0, 1]);
    const careerY = useTransform(scrollYProgress, [0.05, 0.2], [50, 0]);
            ...
            >
                <Parallax>
                    <div ref={ref} className={`grid gap-3 bg-black text-white p-5 ${inView ? 'fade-in' : ''}`}>
                        ...
                        <motion.div style={{ opacity: careerOpacity, y: careerY }}>
